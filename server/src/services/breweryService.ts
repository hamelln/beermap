...
// const breweriesByCity: { [K: string]: any[] } = {
//   seoul: [
//     {
...
export async function loadAllBreweries(): Promise<void> {
  ...
  allBreweries = await presenter.fetchAllBreweries();
...
export function getBreweryById(id: string) {
  return allBreweries.find((brewery: any) => brewery.id === id);
}

export const getBreweriesByQuery = (query: string): Brewery[] => {
